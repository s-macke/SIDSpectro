...
randomlist.push({url: "MUSICIANS/A/Ass_It/Donkey_Kong.sid", song: 1});
...
randomlist.push({url: "MUSICIANS/R/Randall/Smalltown_Boy/Monkey_Island_Title_Theme.sid", song: 1});
...
randomlist.push({url: "MUSICIANS/0-9/4-Mat/Paige.sid", song: 1});
...
randomlist.push({url: "MUSICIANS/F/Fellow/Dance_on_the_Air_intro.sid", song: 1});
...
randomlist.push({url: "MUSICIANS/G/Ghormak/Leisure_Suit_Larry.sid", song: 1});
randomlist.push({url: "GAMES/S-Z/Zak_McKracken.sid", song: 1});
randomlist.push({url: "Other/Top100/Wizardry.sid", song: 1});
...
randomlist.push({url: "MUSICIANS/B/Bakewell_Dwayne/Fairlight.sid", song: 1});
randomlist.push({url: "Other/Top100/Synth_Sample.sid", song: 1});
randomlist.push({url: "Other/Top100/Synth_Sample.sid", song: 3});
randomlist.push({url: "Other/Top100/Synth_Sample.sid", song: 4});
randomlist.push({url: "Other/Top100/Synth_Sample.sid", song: 5});
randomlist.push({url: "Other/Top100/Synth_Sample.sid", song: 6});
randomlist.push({url: "Other/Top100/Synth_Sample.sid", song: 7});
randomlist.push({url: "Other/Top100/Synth_Sample.sid", song: 8});
randomlist.push({url: "Other/Top100/Synth_Sample.sid", song: 9});
...
randomlist.push({url: "MUSICIANS/T/Tankard_Paul/Blues_Brothers.sid", song: 1});
...
randomlist.push({url: "MUSICIANS/B/Bakewell_Dwayne/Fallen.sid", song: 1});
randomlist.push({url: "MUSICIANS/B/Bakewell_Dwayne/Finale.sid", song: 1});
randomlist.push({url: "MUSICIANS/B/Bakewell_Dwayne/Lambada.sid", song: 1});
randomlist.push({url: "MUSICIANS/B/Bakewell_Dwayne/Monty_on_the_Run.sid", song: 1});
randomlist.push({url: "MUSICIANS/B/Bakewell_Dwayne/Outrun_Mix.sid", song: 1});
randomlist.push({url: "MUSICIANS/B/Bakewell_Dwayne/Super_Hang_on_Remix.sid", song: 1});
randomlist.push({url: "MUSICIANS/B/Bakewell_Dwayne/Toccata_v2.sid", song: 1});
randomlist.push({url: "MUSICIANS/B/Bakewell_Dwayne/Thunder_March.sid", song: 1});
randomlist.push({url: "MUSICIANS/B/Bakewell_Dwayne/Sesame_Street.sid", song: 1});
randomlist.push({url: "MUSICIANS/B/Bakewell_Dwayne/Latin_Dance.sid", song: 1});
randomlist.push({url: "MUSICIANS/D/Donovan/Ghost_n_Goblins.sid", song: 1});
//randomlist.push({url: "MUSICIANS/B/Bakewell_Dwayne/Ghost_n_Goblins.sid", song: 1});
randomlist.push({url: "MUSICIANS/B/Bakewell_Dwayne/Fury.sid", song: 1});
randomlist.push({url: "MUSICIANS/B/Bakewell_Dwayne/Eternal_Fall.sid", song: 1});
randomlist.push({url: "MUSICIANS/B/Bakewell_Dwayne/12_Bar_Blues.sid", song: 1});

randomlist.push({url: "DEMOS/UNKNOWN/Magic_Flute.sid", song: 1});
randomlist.push({url: "DEMOS/UNKNOWN/Ninja_Remix.sid", song: 1});
randomlist.push({url: "DEMOS/UNKNOWN/Wanderer_german_version.sid", song: 1});

randomlist.push({url: "Other/Top100/DNA_Warrior.sid", song: 1});

randomlist.push({url: "MUSICIANS/C/Compod/Another_Time.sid", song: 1});
randomlist.push({url: "MUSICIANS/C/Compod/Chopin.sid", song: 1});
randomlist.push({url: "MUSICIANS/C/Compod/Go_West.sid", song: 1});
randomlist.push({url: "MUSICIANS/C/Compod/Magic_of_the_Universe_preview.sid", song: 1});
randomlist.push({url: "MUSICIANS/C/Compod/Nocturno.sid", song: 1});
randomlist.push({url: "MUSICIANS/C/Compod/Worktunes/Project_10.sid", song: 1});
randomlist.push({url: "MUSICIANS/J/Jammer/Lemmings_II_Tunes.sid", song: 1});
randomlist.push({url: "MUSICIANS/T/Tel_Jeroen/Lemmings.sid", song: 2});
randomlist.push({url: "MUSICIANS/T/Tel_Jeroen/Lemmings.sid", song: 3});
randomlist.push({url: "MUSICIANS/T/Tel_Jeroen/Lemmings.sid", song: 10});
randomlist.push({url: "MUSICIANS/E/Eco/A_Neverending_Dream.sid", song: 1});
randomlist.push({url: "MUSICIANS/D/Dunn_David/Elite.sid", song: 1});
randomlist.push({url: "MUSICIANS/D/Dunn_David/Elite.sid", song: 2});
randomlist.push({url: "MUSICIANS/C/Clarke_Peter/Bubble_Bobble.sid", song: 1});
randomlist.push({url: "MUSICIANS/T/Tel_Jeroen/Alternative_Fuel.sid", song: 1});
randomlist.push({url: "MUSICIANS/T/Tel_Jeroen/Looking_Around.sid", song: 1});
randomlist.push({url: "Flimbos_Quest (subtune 3).sid", song: 1});
